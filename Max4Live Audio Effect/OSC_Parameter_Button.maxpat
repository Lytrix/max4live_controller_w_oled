...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "Menu_Select_Parameter.maxpat",
				"bootpath" : "~/Music/Ableton/User Library/Presets/Audio Effects/magnetic_encoder_controller_oled/Max4Live Audio Effect/bpatchers",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
