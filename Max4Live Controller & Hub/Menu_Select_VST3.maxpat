...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 104.0, 286.5, 162.0, 22.0 ],
					"text" : "append \"Select VST3 plugin\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 391.5, 373.0, 77.0, 22.0 ],
					"text" : "plug_vst3 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 305.0, 153.762376308441162, 150.0, 33.0 ],
					"text" : "attach this if you want to auto load a specific plugin"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 315.839999999999975, 104.950000000000003, 41.0, 22.0 ],
					"text" : "del 10"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 98.0, 16.0, 83.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 230.0, 16.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 182.5, 51.0, 40.0, 22.0 ],
					"text" : "b 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 44.0, 286.5, 35.0, 22.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 50.0, 97.0, 53.0, 23.0 ],
					"text" : "listvst3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 305.0, 286.5, 112.0, 23.0 ],
					"text" : "prepend append"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 7,
					"outlettype" : [ "", "", "", "", "", "", "" ],
					"patching_rect" : [ 50.0, 213.5, 614.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 50.0, 179.5, 58.0, 23.0 ],
					"text" : "vstscan"
				}
